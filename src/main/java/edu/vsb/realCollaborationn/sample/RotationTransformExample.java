...
public class RotationTransformExample extends Application {
    @Override public void start(final Stage stage) throws Exception {
        stage.setTitle("Rotation Transform Testbench");
        ...
        VBox box = new VBox();
        box.spacingProperty().setValue(10);
        box.alignmentProperty().setValue(Pos.TOP_CENTER);
        box.getChildren().add(xPivotControl);
        box.getChildren().add(yPivotControl);
        box.getChildren().add(zPivotControl);
        box.getChildren().add(axisControl);
